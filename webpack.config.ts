...
function configure(env: { server?: boolean; production?: boolean } = {}): webpack.Configuration & { devServer: any } {
  ...
  return {
    ...
    plugins: [
      ...
      new (AureliaWebpackPlugin as any).AureliaPlugin(),
      // new webpack.ProvidePlugin({ Promise: 'bluebird' }),
      new (AureliaWebpackPlugin as any).ModuleDependenciesPlugin({ 'aurelia-testing': ['./compile-spy', './view-spy'] })
    ]
  };
}
